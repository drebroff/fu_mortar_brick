...
namespace Drupal\fu_mortar_brick\Authentication\Provider;
...
/**
 * Class FuAuthenticationProvider.
 */
class FuAuthenticationProvider implements AuthenticationProviderInterface {
